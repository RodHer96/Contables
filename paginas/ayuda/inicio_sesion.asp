			...
			<div id="element-box">
				<div class="m" align="center">
					<table align="center" width="50%">
						<tr>
							<td>
								<br>Elementos que conforman la p&aacute;gina de inicio de sesi&oacute;n:
								<br><br>
								<h2>Login:</h2> Este campo se debe ingresar un nombre para accesar al sistema, el cual debe comenzar con una letra may&uacute;scula y las dem&aacute;s min&uacute;sculas o todas may&uacute;sculas;adem&aacute;s debe tener un m&aacute;ximo de 10 caracteres.
								<br><br>
								<h2>Password:</h2> Este campo es obligatorio ya que sera la clave para poder ingresar al sistema, debe terner un m&aacute;ximo de 10 caracteres (al igual que el login) sin importa may&uacute;sculas o min&uacute;sculas, adem&aacute;s puede tener cualquier tipo de texto como s&iacute;mbolos, letras, n&uacute;meros, etc.
								<br><br>
								<table align="center">
								<tr>
