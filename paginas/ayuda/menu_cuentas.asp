					...
					<table align="center" width="50%">
						<tr>
							<td>
								...
								<br>Permite crear una nueva cuenta en el cat&aacute;logo, siempre y cuando no se repita el c&oacute;digo y el nombre de la cuenta.
								<br><br>
								<br><h2>Consultar Cuenta</h2>
								<br>Muestra el c&oacute;digo, nombre, descripci&oacute;n ,tipo de cuenta y el saldo que tiene actualmente.
								<br><br>
								<br><h2>Eliminar Cuenta</h2>
								<br>Muestra el nombre de la cuenta y al seleccionar una se desplegan el c&oacute;digo y la descripci&oacute;n de la misma y luego se elimina.
								<br><br>
								<table align="center">
								<tr>
