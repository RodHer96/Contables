					...
					<table align="center" width="50%">
						<tr>
							<td>
								...
								<br>
								<h1>Nueva</h1>
								<br> Muestra todas la cuentas existentes en el cat&aacute;logo y al seleccionar una se desplegan los datos en el cuadro de abajo donde se ingresa la transacci&oacute;n, en dicho cuadro se muestra el c&oacute;digo de la cuenta, el nombre de la cuenta y la opci&oacute;n de cargar o abonar para ser introducida en los cuadros diario y posteriormente en mayor.
								<br><br>
								<br>
								<h1>Cierre de Periodo</h1>
								<br>Despliegan las fechas de las transacciones hechas durante el periodo contable, luego se cierra el periodo y se desplega un cuadro que proviene de la tabla mayor (existente en la base de datos) y de ah&iacute; aparece un boton que nos permite hacer los ajustes del periodo contable.
								<br><br>
								<table align="center">
								<tr>
